...
\indent Para calcular la relacipon señal a ruido de la última etapa se puede partir de la ecuación \ref{Eq.YN} y como X y W son independientes se puede escrbir:
